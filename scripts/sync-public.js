...
for (const DEST of DESTINATIONS) {
  ...
  for (const f of ['index.html', 'blog.html', 'admin.html', 'privacy.html', 'terms.html', 'library.html', 'tinh-thue.html']) {
  ...
  console.log(`  HTML → index.html, blog.html, admin.html, privacy.html, terms.html, tinh-thue.html`);
