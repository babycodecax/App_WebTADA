...
export async function GET(_req: NextRequest) {
  const urls: string[] = [
    ...
    `  <url><loc>${SITE}/library</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>`,
    `  <url><loc>${SITE}/blog</loc><changefreq>daily</changefreq><priority>0.9</priority></url>`,
    `  <url><loc>${SITE}/tinh-thue</loc><changefreq>weekly</changefreq><priority>0.9</priority></url>`,
